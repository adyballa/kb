...
(function(GD) {
     ...
     */
    GD.Lib.Point.constructor = function(x, y) {
        var _ = {};
        /**
     ...
     * @returns {GD.Lib.Point}
     */
    GD.Lib.Point.prototype.set = function(x, y) {
        this.x = +x;
        this.y = +y;
        return this;
    };
     ...
     * @returns {Point_Pos}
     */
    GD.Lib.Point.prototype.toPos = function() {
        return {
            top : this.y,
            left : this.x
        };
     ...
     */
    GD.Lib.Point.prototype.toDim = function() {
        return {
            width : this.x,
            height : this.y
        };
     ...
     */
    GD.Lib.Point.prototype.toPosPx = function() {
        return {
            top : this.y+"px",
            left : this.x+"px"
        };
     ...
     */
    GD.Lib.Point.prototype.toDimPx = function() {
        return {
            width : this.x+"px",
            height : this.y+"px"
        };
     ...
     * @returns {string}
     */
    GD.Lib.Point.prototype.toString = function() {
     ...
     * @returns {number}
     */
    GD.Lib.Point.prototype.toProduct = function() {
     ...
     * @returns {number}
     */
    GD.Lib.Point.prototype.toSum = function() {
        return this.x+this.y;
    };
     ...
     */
    GD.Lib.Point.prototype.max = function(point) {
        if(point){
     ...
     * @returns {(number|GD.Lib.Point)}
     */
    GD.Lib.Point.prototype.min = function(point) {
        if(point){
     ...
     * @returns {mixed}
     */
    GD.Lib.Point.prototype.compare = function(point, callback) {
